        ...
        <div id="carouselExampleDark" class="carousel carousel-dark slide overflow-hidden rounded" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="10000">
                    <img src="<?php echo get_template_directory_uri() . '/img/slider/slide-1.jpg' ?>" class="d-block w-100">
                </div>
                <div class="carousel-item" data-bs-interval="2000">
                    <img src="<?php echo get_template_directory_uri() . '/img/slider/slide-2.jpg' ?>" class="d-block w-100">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="categories__col col-md-8 col-sm-12 md-3">
                    <a href="#" class="col-md-12 w-100 h-100 d-inline-block p-3 position-relative rounded overflow-hidden">
                        ...
                        <div class=" sale top-0 bottom-0 bg-sale start-0 end-0 position-absolute d-flex justify-content-center align-items-center">
