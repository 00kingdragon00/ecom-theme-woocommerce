                    ...
                    <div class="col-md-4">
                        <ul class="announcement-bar__list">
                            <li>
                                ...
                                <a class="text-decoration-none" href="tel:+91-123-456565">+91-123-456565</a>
                            </li>
                            <li>
                                <i class="bi bi-envelope rounded-circle"></i>
                                <a class="text-decoration-none" href="mail:hello@ecom.local">hello@ecom.local</a>
                            </li>
                        </ul>
                    </div>
        ...
        <header id="masthead" class="site-header">
            ...
            <div class="container pt-2 pb-2">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5"><?php if (function_exists('aws_get_search_form')) {
												aws_get_search_form();
											} ?></div>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center">
                            <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
                                ...
                                <?php esc_html_e('Primary Menu', 'ecom'); ?></button>
                        </div>
